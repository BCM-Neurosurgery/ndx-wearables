...
DeviceBloodOxygen = get_class("DeviceBloodOxygen", "ndx-wearables")
DeviceBreathingDisturbance = get_class("DeviceBreathingDisturbance", "ndx-wearables")
BloodOxygenGroup = get_class("BloodOxygenGroup", "ndx-wearables")
